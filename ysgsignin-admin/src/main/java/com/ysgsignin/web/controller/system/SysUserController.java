...
import com.ysgsignin.common.core.domain.entity.SysDept;
import com.ysgsignin.common.core.domain.entity.SysRole;
...
import com.ysgsignin.system.service.ISysDeptService;
import com.ysgsignin.system.service.ISysPostService;
import com.ysgsignin.system.service.ISysRoleService;
...
//    @PreAuthorize("@ss.hasPermi('system:user:list')")
    ...
    /**
     * @param wxRoleinfo 角色类型
     * @return 返回用户表的学生 还是老师的数据
     */
    @GetMapping("/selectwxlistUser/{wxRoleinfo}")
    public AjaxResult selectWxListUserRoleinfo(@PathVariable("wxRoleinfo") String wxRoleinfo)
    {
        return success(userService.selectWxUserRoleinfo(wxRoleinfo));
    }
